...
def process_corpus(corpus_path: str, target_vocab_size: int = 4999) -> Tuple[List[Tuple[int, int]], Dict[int, Tuple[int, ...]], int, float]:
    """
    Train BPE tokenizer.
    ...
    """
    print("Processing corpus for BPE training...")
